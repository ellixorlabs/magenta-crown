...
function RevenueLineChart({ data }: { data: MonthlyPoint[] }) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-200/90 bg-white p-5 shadow-sm">
      ...
      <svg viewBox={`0 0 ${w} ${h}`} className="h-auto w-full" role="img" aria-label="Revenue line chart">
        <defs>
    ...
    <div className="rounded-2xl border border-zinc-200/90 bg-white shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-100 px-5 py-4">
        <div>
          ...
          <p className="text-xs text-zinc-500">By revenue from paid & shipped orders</p>
        </div>
